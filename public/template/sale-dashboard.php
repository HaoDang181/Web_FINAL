...
<body>
    ...
    // Check if the 'is_active' session variable exists
    if (isset($_SESSION['is_active'])) {
        $isActive = $_SESSION['is_active'];

        // Define the modal classes based on the value of 'is_active'
        ...
        echo '<div class="' . $modalClasses . '" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-modal="true">';
    } else {
        // If 'is_active' session variable does not exist, default to a hidden modal
